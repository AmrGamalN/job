 ...
 *           type: string
 *           format: binary
 *           description: The user profile image file
 *         coverImage:
 *           type: string
 *           format: binary
 *           description: The user profile image file
 ...
 *         status:
 *           type: string
 *           enum: ["pending", "accepted", "unfriend"]
 *           description: The current status of the connection.
 *         blockStatus:
 *           type: string
 *           enum: ["blocked", "unBlocked"]
 *           description: The current block status of the connection.
 *         history:
 *           type: object
 *           properties:
 *             blockStatus:
 ...
 *               format: date-time
 *               nullable: true
 *               description: The time when created connection.
 *             updatedAt:
 *               type: string
 *               format: date-time
 *               nullable: true
 *               description: The time when the updated connection.
 */
 ...
 *         _id:
 *          type: string
 *          description: The ID of the user who owns the follow
 *         followerId:
 *          type: string
 *          description: The ID of the user who owns the follower
 *         followingId:
 *           type: string
 *           description: The  ID for the following
 *         nameFollower:
 *           type: string
